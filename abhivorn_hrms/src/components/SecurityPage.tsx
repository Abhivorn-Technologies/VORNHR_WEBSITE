          ...
          {[
            ...
            <ScrollReveal key={index} delay={index * 0.1} direction="up">
              <motion.div 
                ...
                className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 text-center h-full transition-shadow hover:shadow-xl"
              >
                ...
                <div className="grid md:grid-cols-2 gap-4 mt-6">
                  { [
                    ...
                    <motion.div 
                      ...
                      className="bg-slate-50 rounded-xl p-4 flex items-start gap-3 transition-colors hover:bg-white hover:shadow-md"
                    >
                ...
                <div className="grid md:grid-cols-2 gap-4 mt-6">
                  { [
                    ...
                    <motion.div 
                      key={index} 
                      whileHover={{ scale: 1.05, y: -5 }}
                      className="bg-slate-50 rounded-xl p-5 transition-shadow hover:bg-white hover:shadow-md"
                    >
                      <div className="flex items-center gap-3 mb-3">
          ...
          <div className="mt-12 pt-8 border-t border-slate-200">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                { to: "/cookie-policy", icon: Key, label: "Cookie Policy" },
              ].map((link, index) => (
                <motion.div
                  key={link.to}
